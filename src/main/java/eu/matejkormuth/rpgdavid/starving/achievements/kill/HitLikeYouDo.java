...
public class HitLikeYouDo extends Achievement {

    public HitLikeYouDo() {
        super("Hit like you do", "Kill an enemy with bare hands.");
    }

    @EventHandler
    private void onEntityKilled(final EntityDamageByEntityEvent event) {
        if (event.getDamager() instanceof Player) {
            // Check for bare hands.
            ...
            if (event.getEntity() instanceof LivingEntity &&
                ...
                this.complete((Player) event.getDamager());
            }
        }
    }
