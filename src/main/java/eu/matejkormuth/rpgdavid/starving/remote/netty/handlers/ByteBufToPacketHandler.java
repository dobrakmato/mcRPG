...
import eu.matejkormuth.rpgdavid.starving.remote.netty.PacketFactory;

public class ByteBufToPacketHandler extends
        ReplayingDecoder<Void> {

    private PacketFactory packetFactory;

    public ByteBufToPacketHandler(PacketFactory factory) {
