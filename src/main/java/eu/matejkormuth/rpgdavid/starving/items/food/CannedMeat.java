 ...
 *
 */
package eu.matejkormuth.rpgdavid.starving.items.food;
...
public class CannedMeat extends ConsumableItem {

    public CannedMeat() {
        super(10, 10, new Mapping(Material.COOKED_MUTTON), "Canned Meat");
    }
