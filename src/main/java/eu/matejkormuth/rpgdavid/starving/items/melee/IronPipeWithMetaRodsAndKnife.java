...
public class IronPipeWithMetaRodsAndKnife extends MeleeWeapon {

    public IronPipeWithMetaRodsAndKnife() {
        super(Mappings.IRONPIPEWITHMETALRODSANDKNIFE,
                "Iron Pipe with Metal Rods and Knife", 12, 95);
